...
#[doc=r#"The output of `C:\Users\Chatha\.rustup\toolchains\nightly-x86_64-pc-windows-msvc\bin\rustc.exe -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.82.0-nightly (f8060d282 2024-07-30)";
#[doc=r#"The output of `C:\Users\Chatha\.rustup\toolchains\nightly-x86_64-pc-windows-msvc\bin\rustdoc.exe -V`; empty string if `C:\Users\Chatha\.rustup\toolchains\nightly-x86_64-pc-windows-msvc\bin\rustdoc.exe -V` failed to execute"#]
#[allow(dead_code)]
pub const RUSTDOC_VERSION: &str = r"rustdoc 1.82.0-nightly (f8060d282 2024-07-30)";
